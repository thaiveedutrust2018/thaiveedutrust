...
//Insert Query of SQL
$query= "insert into info(name,age,fathername,gender,religion,bloodgroup,weight,contactnumber,city,education) values ('$name','$age','$fathername','$gender','$religion','$bloodgroup','$weight','$contactnumber','$city','$education')";
